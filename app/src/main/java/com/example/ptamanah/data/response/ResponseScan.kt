...
data class DataNya(
	...
	@field:SerializedName("event_ticket")
	val eventTicket: EventTicket? = null,

	@field:SerializedName("harga")
	val harga: Int? = null,

	@field:SerializedName("e_ticket_id")
	val eTicketId: String? = null,

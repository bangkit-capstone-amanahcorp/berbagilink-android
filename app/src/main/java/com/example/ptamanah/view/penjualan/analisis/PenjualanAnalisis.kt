package com.example.ptamanah.view.penjualan.analisis
...
import com.example.ptamanah.databinding.FragmentPenjualanAnalisisBinding
...
class PenjualanAnalisis : Fragment() {
    private var _binding: FragmentPenjualanAnalisisBinding? = null
    private val binding: FragmentPenjualanAnalisisBinding get() = _binding!!

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        _binding = FragmentPenjualanAnalisisBinding.inflate(inflater, container, false)
        return binding.root
    }
